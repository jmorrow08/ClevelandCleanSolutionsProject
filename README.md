...
photoClientVisible: true/false // Toggle per photo

// Storage path structure:
/servicePhotos/{serviceId}/{employeeId}/{timestamp}.jpg
/servicePhotos/{serviceId}/adminNotes.txt
```
...
- Modern admin portal with full functionality
- Professional employee portal with complete features  
